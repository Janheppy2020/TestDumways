...
<html>
  ...
  <body>
      <center>
        <h1>Edit Produk <?php echo $data['name_produk']; ?></h1>
      <center>
      ...
      <section class="base">
        ...
        <div>
          ...
          <input type="text" name="name_produk" value="<?php echo $data['name_produk']; ?>" autofocus="" required="" />
        </div>
        <div>
          <label>Price</label>
        ...
        <div>
         ...
         <input type="text" name="stock" required="" value="<?php echo $data['importir']; ?>"/>
        </div>
        <div>
